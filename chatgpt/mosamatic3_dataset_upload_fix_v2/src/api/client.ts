...
/**
 * Saves access token to local storage after it has been retrieved from the
 * backend API.
 * @param token 
 */
...
/**
 * General purpose request method to be used by other API services
 * @param path URL endpoint to call
 * @param options 
 * @returns Resonse JSON
 */
